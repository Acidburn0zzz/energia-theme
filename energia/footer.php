	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			<div id="pagefooter">
				...
				Energia sketches are C/C++ based and compiled with the open-source compiler MSPGCC. The Energia language comes from <a href="http://wiring.org.co/" rel="nofollow">Wiring</a>. The Energia environment is based on <a href="http://processing.org/" rel="nofollow">Processing</a> and includes modifications made by Wiring.<br /><br />
				&copy;Energia <br />
				...
				<span class="sep"> | </span>
				<?php printf( __( 'Theme: %1$s by %2$s.', 'energia' ), '<a href="https://github.com/measley/energia-theme" rel="designer">Energia</a>', '<a href="http://underscores.me/" rel="designer">Underscores.me</a>' ); ?>
			</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
